...
present_active = [
    ...
    ["3rd", with_tooltip("λύῃ", "Pres. Act. Subj. 3rd Sg — that he/she/it may loose.<br><span class='note-gold'>Also Pres. Mid./Pass. Ind. 2nd sing.</span><br><span class='note-gold'>Also Pres. Mid./Pass. Subj. 2nd sing.</span>"), with_tooltip("λύωσι(ν)", "Pres. Act. Subj. 3rd Pl — that they may loose")]
]
present_mp = [
