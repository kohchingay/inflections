...
present_active = [
    ...
    ["2nd", with_tooltip("λύεις", "Present Active 2nd singular: you loose"), with_tooltip("λύετε", "Pres.Act.Ind.2nd.plural: you (pl) loose.<br><span class='note-gold'>Also Pres.Act.Imp.2nd.plural</span>")],
...
future_middle = [
    ...
    ["2nd", with_tooltip("λύσῃ", "Future Middle 2nd singular: you will loose for yourself"), with_tooltip("λύσεσθε", "Future Middle 2nd plural: you (pl) will loose for yourselves")],
